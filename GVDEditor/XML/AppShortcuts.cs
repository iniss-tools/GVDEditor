...
namespace GVDEditor.XML
{
    ...
    public class AppShortcuts
    {
        ...
        /// </summary>
        [XmlElement("ShutdownINISS")] public CommandShortcut ShutdownINISS = new(new ShortcutName(Shortcut.ShiftF5));

        /// <summary>
        ///     Skratka pre nutene ukoncenie programu INISS
        /// </summary>
        [XmlElement("KillINISS")] public CommandShortcut KillINISS = new(new ShortcutName(Shortcut.F10));
