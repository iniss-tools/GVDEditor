...
namespace Iniss.Elis
{
    ...
    internal static class TTNative
    {
        ...
        /// <summary>Predvoleny jazyk. Druhy parameter vacsiny funkcii je index jazyka, nie index prvku.</summary>
        ...
        /// </summary>
        public static readonly int[] RegistrationErrors = { 27, 28, 29 };
